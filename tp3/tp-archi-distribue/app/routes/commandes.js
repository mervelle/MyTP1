...
router.post('/', async (req, res) => {
  try {
    ...
    // Publication asynchrone attendue avec await
    await publierCommande({ id: commande._id, produit, client });
...
router.get('/', async (req, res) => {
  try {
    ...
    await redis.setex('toutes_commandes', 30, JSON.stringify(commandes));
